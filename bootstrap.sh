...
# GitHub token for downloading from private repo
GITHUB_TOKEN="REMOVED_TOKEN"

# URL to download the project zip (uses GitHub API for private repo access)
DOWNLOAD_URL="https://api.github.com/repos/tyler-bam-ai/screenrecord/zipball/main"
...
install_files() {
    ...
    if command -v curl &>/dev/null; then
        ...
        wget -q --header="Authorization: token ${GITHUB_TOKEN}" --header="Accept: application/vnd.github+json" "$DOWNLOAD_URL" -O "$TMPZIP"
    else
