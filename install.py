...
def create_config():
    ...
    config_lines = [
        ...
        f"",
        f"# Mouse & keyboard event capture (workflow signal + analysis ground truth)",
        f"# macOS also needs Accessibility / Input Monitoring granted (MDM PPPC).",
        f"input_monitor:",
        f"  enabled: true",
        f"  capture_keystroke_text: true",
        f"  capture_screenshots: false",
        f"",
